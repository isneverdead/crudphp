        ...
        <div class="form-section row justify-content-center">
            <form class="col-10 col-sm-8 col-md-8 col-lg-6" action="" method="post">
                <div class="row mb-3">
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control" id="nppy" name="nppy">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-4 d-flex flex-row justify-content-end">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-8">
                        <select name="mata_kuliah">
                            <option value="Jaringan Komputer 1">Jaringan Komputer 1</option>
                            <option value="Pemograman Web 1">Pemograman Web 1</option>
                            <option value="Desain Grafis 1">Desain Grafis 1</option>
...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO `73_dosen` (`id`, `nppy`, `nama`, `nomor_hp`, `alamat`, `mata_kuliah`) VALUES (NULL,  '$nppy', '$nama', '$nomor_hp', '$alamat', '$mata_kuliah')");

    // var_dump($result);
    if (!$result) {
        echo '<script language="javascript">';
        echo 'alert("Dosen gagal ditambhakan");';
        echo '</script>';
    } else {
        echo '<script language="javascript">';
        echo "window.location.href='./data_dosen.php';";
        echo '</script>';
    }
}
?>