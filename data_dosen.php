...
<body>
    ...
    <div class="tab-content">
        ...
        <a href="./data_dosen.php">
            <button type="button" class="btn btn-primary mx-2">Data Dosen</button>
        </a>
    </div>
    ...
    <div class="table-content">
        <table class="table table-bordered border-dark">
            ...
            <tbody>
                <?php
                $no = 1;
                while ($dosen = mysqli_fetch_array($all_dosen)) {
                    echo "<tr>";
                    echo "<th scope='row'>" . $no++ . "</th>";
                    echo "<td>" . $dosen['nppy'] . "</td>";
                    echo "<td>" . $dosen['nama'] . "</td>";
                    echo "<td>" . $dosen['nomor_hp'] . "</td>";
                    echo "<td>" . $dosen['alamat'] . "</td>";
                    echo "<td>" . $dosen['mata_kuliah'] . "</td>";
                ?>
                    <td><a href='./edit_dosen.php?id=<?= $dosen['id'] ?>'>
                        ...
                        </a> | <a href='delete.php?jenis=dosen&id=<?= $dosen['id'] ?>'>
